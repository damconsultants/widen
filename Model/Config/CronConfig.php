    ...
    public function afterSave()
    {
        ...
        try {
            $this->_configValueFactory->create()->load(
                'crontab/default/jobs/damConsultants_widen_fetch_sku_null_for_magento/schedule/cron_expr',
                'path'
            )->setValue(
                $cronExprString
            )->setPath(
            ...
            $this->_configValueFactory->create()->load(
                'crontab/default/jobs/damConsultants_widen_fetch_sku_null_for_magento/run/model',
                'path'
            )->setValue(
                $this->_runModelPath
            )->setPath(
