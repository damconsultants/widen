...
class InitWidenPopup extends \Magento\Framework\App\Action\Action
{
    /**
     * Get
     *
    ...
    public function __construct(
        ...
        $this->allow_assets_type = ["image","video"];
    ...
    public function execute()
    {
        ...
        if ($query == "modalLoadData") {
            ...
            $selectAllValue = $this->getRequest()->getParam('selectAllValue');
