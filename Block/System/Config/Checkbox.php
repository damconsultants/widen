...
class Checkbox extends Field
{
     ...
     * @var const
     */
    public const CONFIG_PATH = 'widensyncdata/widen_sync_data/check_for_all';
    /**
     * Block template.
     *
     * @var string
     */
    protected $_template = 'DamConsultants_Widen::system/config/checkbox.phtml';
    /**
     * Null Variable
     *
     * @var null
    ...
    public function getValues()
    {
        ...
        $valuess = $objectManager->create(\DamConsultants\Widen\Model\Config\Source\Checkbox::class)->toOptionArray();
